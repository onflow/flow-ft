...
describe("exampletoken", ()=>{
  ...
  beforeEach(async () => {
    ...
    await deployContractByContractCode({ to: serviceAccount,    name: "Token", contractCode: token_contract_code});
    await deployContractByContractCode({ to: serviceAccount,    name: "TestToken", contractCode: test_token_contract_code});
    await deployContractByContractCode({ to: serviceAccount,    name: "TokenSwitchboard", contractCode: token_switchboard_contract_code});
