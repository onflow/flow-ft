...
const get_vault_types = fs.readFileSync(path.resolve(__dirname, "./../../../scripts/switchboard/get_vault_types.cdc"), {encoding:'utf8', flag:'r'});
const get_balance = fs.readFileSync(path.resolve(__dirname, "./../../../scripts/get_balance.cdc"), {encoding:'utf8', flag:'r'});
const get_supported_vault_types = fs.readFileSync(path.resolve(__dirname, "./mocks/scripts/get_supported_vault_types.cdc"), {encoding:'utf8', flag:'r'});
...
const get_balance_read = fs.readFileSync(path.resolve(__dirname, "./mocks/scripts/get_balance.cdc"), {encoding:'utf8', flag:'r'});
const is_recipient_valid = fs.readFileSync(path.resolve(__dirname, "./../../../scripts/tokenForwarder/is_recipient_valid.cdc"), {encoding:'utf8', flag:'r'});
