...
//const get_token_metadata = fs.readFileSync(path.resolve(__dirname, "./../../../scripts/metadata/get_token_metadata.cdc"), {encoding:'utf8', flag:'r'});
//const get_vault_data = fs.readFileSync(path.resolve(__dirname, "./../../../scripts/metadata/get_vault_data.cdc"), {encoding:'utf8', flag:'r'});
const get_vault_display = fs.readFileSync(path.resolve(__dirname, "./../../../scripts/metadata/get_vault_display.cdc"), {encoding:'utf8', flag:'r'});
