...
pub contract TestToken: Token {
    ...
    pub resource Vault: Token.Provider, Token.Receiver, Token.Balance, MetadataViews.Resolver {
        ...
        /// The way of getting a Metadata View out of the TestToken
        ///
    ...
    pub resource Minter {
        ...
        ///
        pub fun mintTokens(amount: UFix64): @TestToken.Vault {
            pre {
    ...
    init() {
        ...
        self.VaultPublicPath = /public/testTokenMetadata
        self.ReceiverPublicPath = /public/testTokenReceiver
        ...
        self.account.link<&TestToken.Vault{Token.Balance}>(
