...
const get_supported_vault_types = fs.readFileSync(path.resolve(__dirname, "./../../../scripts/get_supported_vault_types.cdc"), {encoding:'utf8', flag:'r'});
...
const check_receiver_by_type = fs.readFileSync(path.resolve(__dirname, "./../../../scripts/switchboard/check_receiver_by_type.cdc"), {encoding:'utf8', flag:'r'});
