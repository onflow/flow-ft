...
describe("fungibletokenswitchboard", ()=>{
  ...
  // Sixth test checks if transaction is not rejected if switchboard the vault
  ...
  // Seventh test checks if vault capabilities could be retrieved from a switchboard
