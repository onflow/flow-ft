...
func custodialdepositCdc() (*asset, error) {
	...
	info := bindataFileInfo{name: "CustodialDeposit.cdc", size: 3533, mode: os.FileMode(0644), modTime: time.Unix(1590273780, 0)}
...
func flowtokenCdc() (*asset, error) {
	...
	info := bindataFileInfo{name: "FlowToken.cdc", size: 7477, mode: os.FileMode(0644), modTime: time.Unix(1590273780, 0)}
...
func fungibletokenCdc() (*asset, error) {
	...
	info := bindataFileInfo{name: "FungibleToken.cdc", size: 7298, mode: os.FileMode(0644), modTime: time.Unix(1590273780, 0)}
...
func tokenforwardingCdc() (*asset, error) {
	...
	info := bindataFileInfo{name: "TokenForwarding.cdc", size: 1954, mode: os.FileMode(0644), modTime: time.Unix(1590273780, 0)}
